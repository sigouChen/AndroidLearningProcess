 ...
 */
public class PayBandgeView1 extends LinearLayout {
    ...
    public PayBandgeView1(Context context) {
        super(context);
        init(context);
    }

    public PayBandgeView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PayBandgeView1(Context context, AttributeSet attrs, int defStyleAttr) {
