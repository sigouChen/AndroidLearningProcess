...
public class RetrofitWithRxJava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable<Banner>  result1= bannerInterface.getBanner1();
        result1.observeOn(Schedulers.newThread()).subscribeOn(Schedulers.newThread()).subscribe(new Subscriber<Banner>() {
            @Override
